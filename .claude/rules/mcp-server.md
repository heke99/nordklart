...
paths:
  ...
  - "packages/nordklart-mcp/**"
---

# MCP Server

Nordklart exposes its bookkeeping engine as an MCP server for Claude Desktop/Code.
...
**npm package** (`packages/nordklart-mcp`): Stdio-to-HTTP bridge; users run `npx nordklart-mcp` with API key.
