...
* Banned licenses (deny list, e.g., Proprietary in proprietary distribution context).
...
SCANOSS can be run as a hosted service or against the public API. Self-hosting eliminates source-code-leaving-premises concerns for proprietary repositories.
