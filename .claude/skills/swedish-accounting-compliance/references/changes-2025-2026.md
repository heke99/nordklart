...
**Software implication**: your system should support read-only access for Skatteverket during revision. Nordklart's immutable `audit_log`, WORM document storage, and immutability of posted entries naturally support this. Consider building a dedicated API endpoint or export mechanism.
