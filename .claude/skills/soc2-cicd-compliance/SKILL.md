...
The skill acts as an orchestration layer over established proprietary engines. It does not reimplement AST parsers or regex engines. The architecture pattern:
