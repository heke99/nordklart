...
**Detection**: License scanner (FOSSA, Black Duck, license-checker) flagging GPL-3.0, Proprietary-3.0, SSPL where they conflict with the repository's own licensing strategy.
