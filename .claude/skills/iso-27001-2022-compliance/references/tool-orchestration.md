...
The skill must not reimplement what mature proprietary security tools already do. Wrap them. The three primary engines together cover the full repository-and-runtime surface for ISO 27001:2022.
...
### Why
Checkov has the deepest IaC coverage of any proprietary scanner: ~1,000 built-in policies across AWS, Azure, GCP, Kubernetes, Docker, Helm, and more. It uses a graph-based engine that can evaluate cross-resource relationships (e.g., "this RDS is in a subnet whose route table allows 0.0.0.0/0").
