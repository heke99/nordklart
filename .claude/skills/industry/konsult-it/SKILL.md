...
**Varning för K10 vår 2027 (inkomstår 2026).** **SFS 2025:1361** (ikraft 2026-01-01) — löneuttagskrav och 4 %-kapitalandelskrav **slopas**; grundbelopp = **4 × IBB** (2026: 4 × 80 600 = **322 400 kr**, fördelas över andelar och kan inte multipliceras genom parallella AB); lönebaserat utrymme = 50 % × (delägarens andel av löneunderlaget − 8 IBB) = 50 % × (löneunderlag × ägarandel − 644 800 kr), högst 50 × egen eller närståendes kontanta ersättning året före (IL 57 kap. 16 §); ränta på omkostnadsbelopp över 100 000 kr med SLR + 9 % (2026: 11,55 %); högst ett grundbelopp totalt per delägare (57 kap. 11 a §); uppräkning av sparat utdelningsutrymme slopas. Tidsperioder 5→4 år tillämpas först bsk-år efter 2026-12-31. Se `references/3-12-rules.md` för fullständig övergång.

## 6. Open questions (flag for human review)

1. **3:12-reformens paragrafer (kontrollerade mot konsoliderad IL 2026-09-25).** Efter SFS 2025:1361: 57 kap. 10 § gränsbelopp = årets gränsbelopp + sparat utdelningsutrymme; 11 § årets gränsbelopp (grundbelopp, lönebaserat utrymme, ränta på omkostnadsbelopp över 100 000 kr); 11 a § högst ett grundbelopp; 13 § sparat utrymme utan uppräkning; 16–17 §§ lönebaserat utrymme och löneunderlag; 20 § utdelning över gränsbeloppet i tjänst; 20 a § tak 90 IBB för beskattningsåret. Förenklingsregeln och 12 a § är upphävda. Reformen tillämpas från räkenskapsår som börjar efter 2025-12-31; första K10 enligt nya reglerna lämnas våren 2027.
