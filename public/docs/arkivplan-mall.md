...
| Kontoplan | BAS 2025/2026 (konfigurerad i nordklart) |
...
|---|---|---|---|
| Grundbokföring (registreringsordning) | Elektronisk | nordklart databas | 7 år efter räkenskapsårets utgång |
| Huvudbokföring (systematisk ordning) | Elektronisk | nordklart databas | 7 år efter räkenskapsårets utgång |
| Verifikationer (journalposter) | Elektronisk | nordklart databas | 7 år efter räkenskapsårets utgång |

### 3.2 Verifikationsunderlag

| Räkenskapsinformation | Form | Lagringsplats | Arkiveringstid | Anmärkning |
|---|---|---|---|---|
| Kundfakturor (utgående) | Elektronisk (PDF) | nordklart dokumentarkiv | 7 år | Genereras i nordklart |
| Leverantörsfakturor (inkommande) | Elektronisk (PDF/bild) | nordklart dokumentarkiv | 7 år | Uppladdade/skannade |
| Kvitton | Elektronisk (foto/PDF) | nordklart dokumentarkiv | 7 år | Fotograferade via appen |
| Bankutdrag/kontoutdrag | Elektronisk | nordklart via PSD2-koppling | 7 år | Synkroniserade via Enable Banking |
| Avtal och övriga underlag | [Elektronisk/Papper] | [nordklart / Fysisk pärm] | 7 år | [Ange var dessa förvaras] |

### 3.3 Årsbokslut och årsredovisning

| Räkenskapsinformation | Form | Lagringsplats | Arkiveringstid |
|---|---|---|---|
| Resultaträkning | Elektronisk | nordklart rapportmodul | 7 år |
| Balansräkning | Elektronisk | nordklart rapportmodul | 7 år |
| Årsredovisning (AB) / Årsbokslut (EF) | [Elektronisk/Papper] | [nordklart / Bolagsverket / Fysisk pärm] | 7 år (10 år rekommenderat) |
| NE-bilaga (EF) | Elektronisk | nordklart rapportmodul | 7 år |
...
| Räkenskapsinformation | Form | Lagringsplats | Arkiveringstid |
|---|---|---|---|
| Momsdeklarationer | Elektronisk | nordklart rapportmodul + Skatteverket | 7 år |
| SRU-filer | Elektronisk | nordklart rapportmodul | 7 år |
...
|---|---|---|---|
| Systemdokumentation | Elektronisk | [nordklart / Egen lagring] | Samma som den räkenskapsinformation den avser |
| Behandlingshistorik | Elektronisk | nordklart (automatiskt genererad) | Samma som den räkenskapsinformation den avser |
...
5.1. nordklart sköter automatisk daglig säkerhetskopiering av databasen via Supabase-infrastrukturen.
...
6.1. Vid uppsägning av nordklart-kontot har Kunden nittio (90) dagar att exportera all räkenskapsinformation i enlighet med Användarvillkoren avsnitt 8.

6.2. Räkenskapsinformation som omfattas av sjuårig arkiveringsskyldighet bevaras i skrivskyddat läge av nordklart, alternativt tillhandahålls som fullständig dataexport.
...
7.1. All data i nordklart lagras inom EU/EES via Supabase (AWS-infrastruktur, region eu-central eller eu-west).
