 ...
 * --force is passed.
 *
 * Usage: npx tsx scripts/set-nordklart-org-number.ts <COMPANY_ID> <ORG_NUMBER_10DIGIT> [--force]
 */
...
if (!companyId || !orgNumberRaw) {
  console.error('Usage: npx tsx scripts/set-nordklart-org-number.ts <COMPANY_ID> <ORG_NUMBER_10DIGIT> [--force]')
  process.exit(1)
}
