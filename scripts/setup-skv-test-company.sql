-- Set up a nordklart test company that mirrors the testredovisare
-- Skatteverket has wired for your test BankID.
--
-- Replace the three placeholders below before running:
--   :user_id                — auth.users.id of the dev user signed in to nordklart
--                              (your nordklart login email's user row)
