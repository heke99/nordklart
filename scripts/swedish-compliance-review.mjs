...
function buildSystemPrompt({ primary, others }) {
  ...
  return `You are reviewing a pull request in **nordklart**, a Swedish accounting SaaS built in Next.js + TypeScript on top of Supabase. Your job is to flag compliance risks against Swedish accounting law (Bokföringslagen / BFL), BFNAR, tax law, BAS 2026 chart, and VAT rules (ML 2023:200).
