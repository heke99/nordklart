/**
 * Create a dedicated SKV test company in nordklart.
 *
 * Why this exists: testing the Skatteverket sandbox APIs against Nordklart's real
 * orgnummer would put real revenue/VAT figures in SKV's test logs under the
 * real entity. Better hygiene: a separate nordklart company that uses one of
