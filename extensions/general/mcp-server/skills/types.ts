 ...
 *    payroll). They document *how* to compose Nordklart tools for a real-world
 *    workflow.
 ...
 *
 * Agents call `nordklart_list_skills` to discover, then `nordklart_load_skill(slug)`
...
/**
 * Pre-conditions a skill needs to be relevant to a company. `nordklart_list_skills`
...
export interface Skill {
  ...
  name: string
  /** One-line summary used by nordklart_list_skills. */
  summary: string
  ...
  tier: SkillTier
  /** Optional company-context filter applied by nordklart_list_skills. */
...
export const SKILL_URI_PREFIX = 'Nordklart://skill/' as const
