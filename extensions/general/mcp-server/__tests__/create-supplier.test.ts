/**
 * Unit tests for nordklart_create_supplier — registration, risk tier, and
...
const tool = () => tools.find((t) => t.name === 'nordklart_create_supplier')!

describe('nordklart_create_supplier — registration', () => {
  ...
  it('is mapped to suppliers:write scope', () => {
    expect(TOOL_SCOPE_MAP.nordklart_create_supplier).toBe('suppliers:write')
  })
...
describe('nordklart_create_supplier — input validation', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
 ...
 */
describe('nordklart_create_supplier — staging behaviour', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
