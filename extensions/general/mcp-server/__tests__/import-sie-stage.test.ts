/**
 * Stage-time validation for nordklart_import_sie.
 *
...
const importSie = tools.find((t) => t.name === 'nordklart_import_sie')!
...
describe('nordklart_import_sie — stage-time validation', () => {
...
describe('nordklart_import_sie — update_account_names staging', () => {
