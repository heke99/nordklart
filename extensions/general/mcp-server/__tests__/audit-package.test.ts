/**
 * Unit tests for nordklart_audit_package.
 *
...
describe('nordklart_audit_package — registration', () => {
  it('is registered', () => {
    const tool = tools.find((t) => t.name === 'nordklart_audit_package')
  ...
  it('is mapped to reports:read scope', () => {
    expect(TOOL_SCOPE_MAP.nordklart_audit_package).toBe('reports:read')
  })
})
...
describe('nordklart_audit_package — execute', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
