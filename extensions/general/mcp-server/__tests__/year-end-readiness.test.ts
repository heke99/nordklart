/**
 * Unit tests for nordklart_year_end_readiness.
 *
...
describe('nordklart_year_end_readiness — registration', () => {
  it('is registered in the tools array', () => {
    const tool = tools.find((t) => t.name === 'nordklart_year_end_readiness')
  ...
  it('is mapped to reports:read scope', () => {
    expect(TOOL_SCOPE_MAP.nordklart_year_end_readiness).toBe('reports:read')
  })
})
...
describe('nordklart_year_end_readiness — execute', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
