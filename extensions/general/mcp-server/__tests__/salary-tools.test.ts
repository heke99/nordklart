 ...
 * nordklart_create_salary_run and nordklart_generate_agi STAGE a pending_operation
 ...
 *
 * nordklart_calculate_salary_run still calls the calculation lib synchronously
...
const createSalaryRun = tools.find((t) => t.name === 'nordklart_create_salary_run')!
const calculateSalaryRun = tools.find((t) => t.name === 'nordklart_calculate_salary_run')!
const generateAgi = tools.find((t) => t.name === 'nordklart_generate_agi')!

beforeEach(() => {
  vi.clearAllMocks()
})

describe('nordklart_calculate_salary_run', () => {
  it('calls runSalaryCalculation directly — never a self-fetch', async () => {
    ...
    expect(result.next.tool).toBe('nordklart_get_salary_run')
...
describe('nordklart_generate_agi', () => {
...
describe('nordklart_create_salary_run', () => {
