/**
 * Unit tests for nordklart_auto_match_period.
 *
...
describe('nordklart_auto_match_period — registration', () => {
  it('is registered', () => {
    const tool = tools.find((t) => t.name === 'nordklart_auto_match_period')
  ...
  it('is mapped to transactions:write scope', () => {
    expect(TOOL_SCOPE_MAP.nordklart_auto_match_period).toBe('transactions:write')
  })
})
...
describe('nordklart_auto_match_period — dry run', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
