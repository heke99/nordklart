/**
 * Unit tests for nordklart_query_journal.
 *
...
describe('nordklart_query_journal — registration', () => {
  it('is registered and read-only', () => {
    const tool = tools.find((t) => t.name === 'nordklart_query_journal')
  ...
  it('is mapped to reports:read scope', () => {
    expect(TOOL_SCOPE_MAP.nordklart_query_journal).toBe('reports:read')
  })
})
...
describe('nordklart_query_journal — execute', () => {
...
describe('nordklart_query_journal — free-text search', () => {
