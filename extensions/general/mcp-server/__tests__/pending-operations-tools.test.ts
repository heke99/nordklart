...
const listTool = tools.find((t) => t.name === 'nordklart_list_pending_operations')!
const approveTool = tools.find((t) => t.name === 'nordklart_approve_pending_operation')!
const rejectTool = tools.find((t) => t.name === 'nordklart_reject_pending_operation')!
...
describe('pending_operations MCP tools — registration', () => {
  ...
  it('list is gated by pending_operations:read', () => {
    expect(TOOL_SCOPE_MAP['nordklart_list_pending_operations']).toBe('pending_operations:read')
  })

  it('approve and reject are gated by pending_operations:approve', () => {
    expect(TOOL_SCOPE_MAP['nordklart_approve_pending_operation']).toBe('pending_operations:approve')
    expect(TOOL_SCOPE_MAP['nordklart_reject_pending_operation']).toBe('pending_operations:approve')
  })
...
describe('nordklart_list_pending_operations', () => {
...
describe('nordklart_approve_pending_operation', () => {
...
describe('nordklart_reject_pending_operation', () => {
