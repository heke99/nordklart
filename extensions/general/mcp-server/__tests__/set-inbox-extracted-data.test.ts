...
const tool = tools.find((t) => t.name === 'nordklart_set_inbox_extracted_data')!
...
describe('nordklart_set_inbox_extracted_data — registration', () => {
  it('is registered with the right scope', () => {
    expect(tool).toBeDefined()
    expect(TOOL_SCOPE_MAP['nordklart_set_inbox_extracted_data']).toBe('suppliers:write')
  })
...
describe('nordklart_set_inbox_extracted_data — happy path', () => {
...
describe('nordklart_set_inbox_extracted_data — validation & guards', () => {
