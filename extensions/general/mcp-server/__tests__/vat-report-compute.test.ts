 ...
 * nordklart_get_vat_report and nordklart_vat_review_widget. These exist because the
...
describe('computeVatReport', () => {
  ...
  it('exposes a rich outputSchema on both VAT tools (not bare {type:object})', () => {
    for (const name of ['nordklart_get_vat_report', 'nordklart_vat_review_widget']) {
