/**
 * Stage-time pre-flight for nordklart_undo_sie_import.
 *
...
const undoTool = tools.find((t) => t.name === 'nordklart_undo_sie_import')!

beforeEach(() => {
  vi.clearAllMocks()
})

describe('nordklart_undo_sie_import — stage-time validation', () => {
