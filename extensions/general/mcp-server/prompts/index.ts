 ...
 * the model to call exactly one Nordklart tool and report a short answer.
 */
export const prompts: McpPrompt[] = [
  {
    ...
    text:
      'Lista mina förfallna kundfakturor. Anropa nordklart_list_invoices med status="overdue" ' +
  ...
  },
  {
    ...
    text:
      'Hur mycket pengar har jag på företagskontot just nu? Anropa nordklart_get_balance_sheet ' +
      'för dagens datum och rapportera saldot på konto 1930. Visa även de senaste 5 transaktionerna ' +
      'via nordklart_list_uncategorized_transactions (limit=5, sortera nyast först — men inkludera även ' +
  ...
  },
  {
    ...
    text:
      'Visa resultaträkningen för föregående kalendermånad. Anropa nordklart_get_income_statement ' +
  ...
  },
  {
    ...
    text:
      'Vad är min momsskuld eller momsfordran för innevarande momsperiod? Anropa nordklart_get_vat_report ' +
  ...
  },
  {
    ...
    text:
      'Hur många banktransaktioner är okontrerade? Anropa nordklart_list_uncategorized_transactions ' +
