 ...
 * Triggered by the nordklart_receipt_matcher tool.
 */
...
<title>Kvittomatchning — Nordklart</title>
<style>
  :root {
    --bg: #fafafa;
    --surface: #ffffff;
...
(function() {
  ...
  sendRequest('ui/initialize', {
    name: 'nordklart-receipt-matcher',
    version: '1.0.0'
  }).then(function(res) {
  ...
  function bookTransaction(idx) {
    ...
    callTool('nordklart_categorize_transaction', {
