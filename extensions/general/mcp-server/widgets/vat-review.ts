 ...
 * Triggered by the nordklart_vat_review_widget tool.
 */
...
<title>Momsdeklaration — Nordklart</title>
<style>
  :root {
    --bg: #fafafa;
    --surface: #ffffff;
...
(function() {
  ...
  sendRequest('ui/initialize', { name: 'nordklart-vat-review', version: '1.0.0' })
    .then(function(res) {
