  ...
  read: async ({ supabase, companyId }) => {
    ...
    if (overdueAll.length > 0) {
      ...
      categories.push({
        ...
        next: {
          ...
          resource: 'Nordklart://recent-activity?limit=20',
        },
      })
    }
    ...
    if (pendingSupplierCount > 0) {
      ...
      categories.push({
        ...
        next: {
          ...
          tool: 'nordklart_approve_supplier_invoice',
    ...
    if (pendingOpsCount > 0) {
      ...
      categories.push({
        ...
        next: {
          description:
            'Visa kön för användaren. När användaren godkänner en specifik operation_id i chatten, anropa nordklart_approve_pending_operation direkt — /pending är ett alternativ, inte ett krav.',
          tool: 'nordklart_list_pending_operations',
        },
      })
    }
    ...
    if (unmatchedReceiptsCount > 0) {
      ...
      categories.push({
        ...
        next: {
          ...
          tool: 'nordklart_receipt_matcher',
      ...
      if (unexplained.length > 0) {
        ...
        categories.push({
          ...
          next: {
            ...
            tool: 'nordklart_explain_voucher_gap',
            args: first
              ? {
