...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Docs canonicalised to docs.nordklart.se. Every `docs_url` field on the
      ...
      {
        source: '/docs/api',
        destination: 'https://docs.nordklart.se/',
        permanent: true,
      },
      {
        source: '/docs/api/:path*',
        destination: 'https://docs.nordklart.se/:path*',
        permanent: true,
      },
      {
        source: '/llms-full.txt',
        destination: 'https://docs.nordklart.se/llms-full.txt',
        permanent: true,
      },
    ]
  },
