...
export const GET = withRouteContext('bookkeeping.mapping_rules.get', async (_request, ctx) => {
...
export const POST = withRouteContext('bookkeeping.mapping_rules.post', async (request, ctx) => {
