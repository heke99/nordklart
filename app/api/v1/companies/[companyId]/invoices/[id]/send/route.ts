...
registerEndpoint({
  ...
  useWhen:
    'You want Nordklart to deliver the invoice to the customer via email. For invoices delivered through another channel (Peppol, postal, own SMTP) use :mark-sent instead.',
  doNotUseFor:
  ...
  example: {
    response: {
      data: {
        ...
        cc: 'billing@nordklart-user.test',
