...
export default async function SelectCompanyPage() {
  ...
  // Existing Nordklart memberships.
  ...
  // Drop TIC roles that already appear in the user's Nordklart memberships —
  // those render via the "Your Nordklart companies" section above instead.
  ...
  // table to detect "exists in Nordklart, user not a member" cases. Use the
