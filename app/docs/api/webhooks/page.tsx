...
export const metadata: Metadata = {
  title: 'Webhooks · nordklart API',
  description: 'Receive HMAC-signed POST notifications when state changes in nordklart. Includes signature verification samples in Node.js and Python.',
}
