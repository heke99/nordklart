...
export const metadata: Metadata = {
  title: 'Connect with Claude · nordklart API',
  description:
    'Connect Nordklart to Claude (claude.ai, Claude Desktop, Claude Code) via the MCP server — OAuth 2.1 connector or the npx nordklart-mcp stdio bridge.',
}
