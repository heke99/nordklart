    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/docs/api" className="font-display text-xl tracking-tight" style={{ fontWeight: 700 }}>
            nordklart <span className="text-muted-foreground" style={{ fontWeight: 400 }}>/ docs</span>
          </Link>
      ...
      <footer className="border-t border-border mt-20">
        <div className="max-w-7xl mx-auto px-6 py-8 text-sm text-muted-foreground flex items-center justify-between">
          <span>nordklart REST API · Swedish bookkeeping for agents</span>
          <span className="font-mono text-xs">Proprietary</span>
        </div>
      </footer>
    </div>
  )
