...
function subscribe(callback: () => void): () => void {
  ...
  window.addEventListener('nordklart-periodisering-toggle', customHandler)
  return () => {
    window.removeEventListener('storage', handler)
    window.removeEventListener('nordklart-periodisering-toggle', customHandler)
  }
}
...
function notifyChange() {
  if (typeof window === 'undefined') return
  window.dispatchEvent(new Event('nordklart-periodisering-toggle'))
}
