...
export default function InvoiceInboxWorkspace(_props: WorkspaceComponentProps) {
  ...
  const handleDismissOnboarding = useCallback(() => {
    try {
      window.localStorage.setItem('nordklart.inbox.onboarding.dismissed', '1')
    } catch {
...
function OnboardingCard({
  ...
  const steps = [
    ...
    },
    {
      ...
      hint: 'nordklart tolkar fakturan eller kvittot åt dig och fyller i fält automatiskt.',
    },
    {
    ...
    >
      ...
      <div className={cn('space-y-1', compact ? 'pr-6' : 'pr-8')}>
        ...
        <p className={cn('text-muted-foreground', compact ? 'text-[11px]' : 'text-xs')}>
          ...
          <a
            href="https://www.nordklart.se/priser"
            target="_blank"
