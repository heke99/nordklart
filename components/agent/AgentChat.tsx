...
interface StagedOperation {
  ...
  message: string
  // The originating tool name (e.g. 'nordklart_categorize_transaction'). Lets
        ...
        <div className="w-full max-w-[85%] space-y-2">
          {message.staged.map((s) =>
            s.operation_id ? (
              ...
              >
                Förslag stageat men ingen operation-id mottagen. Granska i nordklart under <em>Förslag</em>.
              </div>
            ),
          )}
        </div>
...
// humanized stem ("nordklart_foo_bar" → "kör foo bar…").
const TOOL_BADGE_LABELS: Record<string, string> = {
  // Discovery
  nordklart_search_tools: 'Letar efter verktyg…',
  nordklart_list_skills: 'Letar bland kunskap…',
  nordklart_load_skill: 'Slår upp regelverk…',
  // Reading / context
  nordklart_get_document_content: 'Läser underlaget…',
  nordklart_get_counterparty_templates: 'Letar i mottagar­mallar…',
  nordklart_get_supplier_ledger: 'Hämtar leverantörshistorik…',
  nordklart_get_ar_ledger: 'Hämtar kundreskontra…',
  nordklart_get_trial_balance: 'Hämtar saldobalans…',
  nordklart_get_balance_sheet: 'Hämtar balansräkning…',
  nordklart_get_income_statement: 'Hämtar resultatrapport…',
  nordklart_get_general_ledger: 'Slår i huvudboken…',
  nordklart_get_kpi_report: 'Beräknar nyckeltal…',
  nordklart_get_vat_report: 'Hämtar momsrapport…',
  nordklart_vat_close_check: 'Kontrollerar momsperiod…',
  nordklart_query_journal: 'Söker i bokföringen…',
  nordklart_year_end_readiness: 'Kontrollerar bokslutsläge…',
  nordklart_list_customers: 'Söker bland kunder…',
  nordklart_list_invoices: 'Listar fakturor…',
  // Writes (staged)
  nordklart_categorize_transaction: 'Förbereder bokning…',
  nordklart_match_transaction_to_invoice: 'Matchar mot faktura…',
  nordklart_create_customer: 'Skapar kund…',
  nordklart_create_invoice: 'Förbereder faktura…',
  nordklart_create_voucher: 'Förbereder verifikation…',
  nordklart_create_transactions: 'Förbereder transaktioner…',
  nordklart_approve_supplier_invoice: 'Stagear attestering…',
  nordklart_credit_supplier_invoice: 'Förbereder kreditfaktura…',
  nordklart_propose_accruals: 'Räknar fram periodiseringar…',
  nordklart_propose_annual_depreciation: 'Beräknar avskrivningar…',
  nordklart_propose_dispositioner: 'Förbereder dispositioner…',
  nordklart_preview_arsredovisning: 'Förhandsgranskar årsredovisning…',
  nordklart_preview_ef_declaration: 'Förbereder NE-bilaga…',
  nordklart_post_annual_depreciation: 'Bokar avskrivningar…',
  // Memory
  nordklart_remember_fact: 'Sparar i minnet…',
  nordklart_forget_fact: 'Tar bort från minnet…',
}

function prettyToolName(name: string): string {
  if (TOOL_BADGE_LABELS[name]) return TOOL_BADGE_LABELS[name]
  return `kör ${name.replace(/^nordklart_/, '').replace(/_/g, ' ')}…`
}
