...
export default function TransactionInboxCard({
  ...
  // via the Nordklart:transaction-document-linked window event (AgentChat
  ...
  useEffect(() => {
    ...
    window.addEventListener('Nordklart:transaction-document-linked', onLinked)
    return () => window.removeEventListener('Nordklart:transaction-document-linked', onLinked)
  }, [transaction.id])
