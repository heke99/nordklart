...
if [ ! -f .env.docker.example ]; then
  echo "ERROR: .env.docker.example not found. Are you in the Nordklart directory?"
  exit 1
fi
...
echo ""
echo "Next steps:"
echo "  1. Apply database migrations (see DEPLOYMENT.md section 3)"
