 ...
 *   2. Extracts and validates the `Authorization: Bearer nordklart_sk_...` header
 ...
 *   8. Stamps `X-Request-Id`, `Nordklart-Version`, `X-RateLimit-Limit` on the
 *      response.
...
export { truncateIp } from '@/lib/api/truncate-ip'
