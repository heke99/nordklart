...
const KEY_PREFIX = 'nordklart_sk_'
const REFRESH_TOKEN_PREFIX = 'nordklart_rt_'
 ...
 * (nordklart_remember_fact/forget_fact) write advisory agent context — they
...
export const TOOL_SCOPE_MAP: Record<string, ApiKeyScope> = {
  ...
  nordklart_list_transactions_without_documents: 'transactions:read',
  nordklart_create_transactions:                 'transactions:write',
  nordklart_categorize_transaction:              'transactions:write',
  nordklart_receipt_matcher:                     'transactions:write',
  nordklart_get_counterparty_templates:          'transactions:read',
  nordklart_suggest_categories:                  'transactions:read',
  nordklart_match_transaction_to_invoice:        'transactions:write',
  nordklart_link_transaction_to_journal_entry:   'transactions:write',
  nordklart_match_batch_allocate:                'transactions:write',
  nordklart_bulk_book_transactions:              'transactions:write',
  nordklart_auto_match_period:                   'transactions:write',
  // Customers
  nordklart_list_customers:                  'customers:read',
  nordklart_create_customer:                 'customers:write',
  // Invoices
  nordklart_list_invoices:                   'invoices:read',
  nordklart_create_invoice:                  'invoices:write',
  nordklart_send_invoice:                    'invoices:write',
  nordklart_mark_invoice_as_paid:            'invoices:write',
  nordklart_mark_invoice_as_sent:            'invoices:write',
  // Suppliers
  nordklart_list_suppliers:                  'suppliers:read',
  nordklart_list_supplier_invoices:          'suppliers:read',
  // Reports
  nordklart_get_trial_balance:               'reports:read',
  nordklart_get_vat_report:                  'reports:read',
  nordklart_vat_review_widget:               'reports:read',
  nordklart_vat_close_check:                 'reports:read',
  nordklart_get_kpi_report:                  'reports:read',
  nordklart_get_income_statement:            'reports:read',
  nordklart_list_accounts:                   'reports:read',
  nordklart_get_balance_sheet:               'reports:read',
  nordklart_get_general_ledger:              'reports:read',
  nordklart_query_journal:                   'reports:read',
  nordklart_get_ar_ledger:                   'reports:read',
  nordklart_get_supplier_ledger:             'reports:read',
  nordklart_list_fiscal_periods:             'reports:read',
  nordklart_get_reconciliation_status:       'reports:read',
  // Document inbox
  nordklart_upload_document:                 'transactions:write',
  nordklart_list_inbox_items:                'transactions:read',
  nordklart_get_inbox_item:                  'transactions:read',
  nordklart_list_unmatched_documents:        'transactions:read',
  nordklart_get_document_content:            'transactions:read',
  nordklart_attach_document_to_transaction:  'transactions:write',
  // Payroll
  nordklart_list_employees:                  'payroll:read',
  nordklart_get_salary_run:                  'payroll:read',
  nordklart_get_salary_journal:              'payroll:read',
  nordklart_create_salary_run:               'payroll:write',
  nordklart_calculate_salary_run:            'payroll:write',
  nordklart_generate_agi:                    'payroll:write',
  // Bookkeeping write (Stream 1 Phase 1) — high-risk, always staged
  nordklart_close_period:                    'bookkeeping:write',
  nordklart_lock_period:                     'bookkeeping:write',
  nordklart_unlock_period:                   'bookkeeping:write',
  nordklart_run_year_end:                    'bookkeeping:write',
  nordklart_year_end_readiness:              'reports:read',
  nordklart_set_opening_balances:            'bookkeeping:write',
  nordklart_run_currency_revaluation:        'bookkeeping:write',
  nordklart_explain_voucher_gap:             'bookkeeping:write',
  nordklart_list_voucher_gaps:               'reports:read',
  // Transaction reversal (medium-risk)
  nordklart_uncategorize_transaction:        'transactions:write',
  // SIE export (read-only) + import (write)
  nordklart_export_sie:                      'reports:read',
  nordklart_audit_package:                   'reports:read',
  nordklart_import_sie:                      'bookkeeping:write',
  // Supplier CRUD
  nordklart_create_supplier:                 'suppliers:write',
  // Supplier invoice lifecycle
  nordklart_approve_supplier_invoice:        'suppliers:write',
  nordklart_credit_supplier_invoice:         'suppliers:write',
  nordklart_create_supplier_invoice_from_inbox: 'suppliers:write',
  nordklart_set_inbox_extracted_data:        'suppliers:write',
  // Supplier invoice payment via existing verifikat (no new bokföring)
  nordklart_find_voucher_candidates_for_supplier_invoice: 'suppliers:read',
  nordklart_link_supplier_invoice_to_voucher: 'suppliers:write',
  // Invoice conversion + crediting
  nordklart_convert_invoice:                 'invoices:write',
  nordklart_credit_invoice:                  'invoices:write',
  // Phase 4: arbitrary-line bookkeeping primitives (high-risk, always staged)
  nordklart_create_voucher:                  'bookkeeping:write',
  nordklart_correct_entry:                   'bookkeeping:write',
  nordklart_reverse_journal_entry:           'bookkeeping:write',
  // Agent surface (Phase 6 MCP parity): briefing tool exposes company-specific
  // profile + memory so it's scoped; nordklart_list_skills / nordklart_load_skill
  // stay unscoped (discovery + static Markdown bodies + globally-readable atom
  // registry — no per-company data).
  nordklart_get_agent_briefing:              'agent:read',
  ...
  nordklart_remember_fact:                   'agent:write',
  nordklart_forget_fact:                     'agent:write',
