 ...
 *
 * If nothing is set, Nordklart defaults are returned — production behaviour
...
export interface BrandingConfig {
   ...
   * Set per-brand; default `'standard'` so hosted is unchanged.
   */
