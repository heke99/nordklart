...
>({
  ...
  promptTemplate: ({ captured, profileSummary }) => {
    ...
    lines.push('1. Föreslå rätt BAS-konton baserat på beskrivningen. Syns en motpart i beskrivningen — kolla historiken med nordklart_query_journal({ text: "<motpartens namn>", limit: 5 }).')
    ...
    lines.push('4. Staga via nordklart_create_voucher när allt stämmer.')
    lines.push('')
