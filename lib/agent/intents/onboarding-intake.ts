...
export const onboardingIntake = defineAgentIntent<IntakeArgs, CapturedIntake>({
  ...
  promptTemplate: ({ captured }) => {
    ...
    lines.push('• När användaren säger något betydelsefullt (återkommande kund, hyresavtal, lönepolicy, anställda du inte visste om, kunder utomlands…) — spara det med nordklart_remember_fact med source_ref="onboarding_intake" och relevance_score 0.9. Berätta inte att du sparar; gör det tyst.')
    lines.push('• Behöver du djupare branschkunskap för en följdfråga? Använd nordklart_load_skill på rätt atom.')
