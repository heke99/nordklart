...
export const bokslutStep = defineAgentIntent<BokslutStepArgs, CapturedBokslutStep>({
  ...
  tools: [
    ...
    'nordklart_propose_accruals',
    'nordklart_propose_annual_depreciation',
    'nordklart_propose_dispositioner',
    'nordklart_preview_arsredovisning',
    'nordklart_preview_ef_declaration',
  ...
  promptTemplate: ({ captured, profileSummary }) => {
    ...
    lines.push('1. Kör nordklart_year_end_readiness för att se vad som saknas.')
    lines.push('2. Om steget är "accruals": använd nordklart_propose_accruals för periodiseringar och förklara varje förslag (när påverkar det BR/RR, varför detta belopp?).')
    lines.push('3. Om steget är "depreciation": nordklart_propose_annual_depreciation. Förklara planenlig vs. överavskrivning, K2 schablonregler vs. K3 individual.')
    lines.push('4. Om steget är "dispositioner": nordklart_propose_dispositioner. Periodiseringsfond, koncernbidrag (om holding), årets skatt.')
    lines.push('5. Om steget är "arsredovisning": preview via nordklart_preview_arsredovisning, granska noter, förvaltningsberättelse, underskrifter, deadline.')
    lines.push('6. Om EF: använd nordklart_preview_ef_declaration. Räntefördelning, expansionsfond, NE-bilaga.')
    lines.push('')
