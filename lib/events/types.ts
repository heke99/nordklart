...
export type CoreEvent =
  ...
  // (nordklart_search_tools) or pulling the full list. Tool counts vary with
  ...
  | { type: 'mcp.resource_read'; payload: {
      uri: string                                   // e.g. 'Nordklart://skill/month-end-close'
  ...
  // nordklart_load_skill (or implicitly by following a skill's recommended tool
  ...
  // Fires on EVERY successful nordklart_load_skill — all tiers, unlike
  ...
  // Agent self-reported feedback (nordklart_feedback tool). The product team
