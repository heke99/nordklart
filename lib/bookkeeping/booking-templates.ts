...
export const BOOKING_TEMPLATES: readonly BookingTemplate[] = [
  ...
  },
  {
    ...
    name_sv: 'Försäljning 12% moms (restaurang/logi)',
    name_en: 'Revenue 12% VAT (restaurant/accommodation)',
    group: 'revenue',
    direction: 'income',
    entity_applicability: 'all',
    debit_account: '1930',
    ...
    deductibility: 'full',
    mcc_codes: [],
    keywords: ['restaurang', 'servering', 'catering', 'logi', 'hotell', 'camping'],
    risk_level: 'NONE',
    requires_review: false,
    impact_score: 6,
    auto_match_confidence: 0.75,
    ...
    description_sv: 'Restaurang- och cateringtjänster samt logi med 12% moms.',
    common: true,
  },
  {
    id: 'revenue_food_6',
    name_sv: 'Försäljning livsmedel 6% moms (2026-04-01–2027-12-31)',
    name_en: 'Revenue food 6% VAT (2026-04-01–2027-12-31)',
    group: 'revenue',
    direction: 'income',
    entity_applicability: 'all',
    debit_account: '1930',
    ...
    deductibility: 'full',
    mcc_codes: [],
    keywords: ['livsmedel', 'mat', 'food', 'dagligvaror', 'takeaway', 'avhämtning'],
    risk_level: 'NONE',
    requires_review: false,
    impact_score: 6,
    auto_match_confidence: 0.75,
    default_private: false,
    fallback_category: 'income_products',
    description_sv: 'Försäljning av livsmedel (även takeaway utan servering) med tillfälligt sänkt moms 6% för leveranser 2026-04-01–2027-12-31. Före och efter perioden gäller 12%. Starköl, vin och sprit har 25%.',
    common: true,
  },
  {
