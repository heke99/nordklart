...
export const DOCS_NAV: DocsNavSection[] = [
  {
    ...
    links: [
      { label: 'Introduction', href: '/docs/api', summary: 'What the Nordklart REST API is and how to authenticate.' },
      ...
      { label: 'Connect with Claude', href: '/docs/api/connect-claude', summary: 'Connect Claude via the MCP server — OAuth connector or npx nordklart-mcp bridge.' },
    ],
  },
  {
    label: 'Cookbooks',
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Bank connections', href: '/docs/api/reference/bank-connections' },
      { label: 'Audit logs', href: '/docs/api/reference/audit-logs' },
      { label: 'Bankgiro applications', href: '/docs/api/reference/bankgiro-applications' },
      { label: 'Tax submissions', href: '/docs/api/reference/tax-submissions' },
      { label: 'Year-end projects', href: '/docs/api/reference/year-end-projects' },
      { label: 'Invoice financing', href: '/docs/api/reference/invoice-financing' },
