...
\`\`\`bash
curl "https://app.nordklart.se/api/v1/companies/$COMPANY_ID/reports/vat-declaration?period=2026-04" \\
...
\`\`\`bash
curl "https://app.nordklart.se/api/v1/companies/$COMPANY_ID/compliance/check?type=voucher_gaps&period=2026-04" \\
  -H "Authorization: Bearer nordklart_sk_test_..."
\`\`\`
...
\`\`\`bash
curl -X PATCH "https://app.nordklart.se/api/v1/companies/$COMPANY_ID/fiscal-periods/$PERIOD_ID" \\
  -H "Authorization: Bearer nordklart_sk_test_..." \\
