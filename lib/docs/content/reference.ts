...
export function buildReferenceOverviewMd(): string {
  ...
  lines.push('')
  lines.push(`> Every endpoint exposed by the Nordklart REST API, grouped by resource. Auto-generated from the same Zod registry that powers the [OpenAPI 3.1 spec](/api/v1/openapi.json), the MCP tool surface, and runtime validators — there is no separate doc-source to keep in sync.`)
  lines.push('')
