...
--
-- Fix: introduce a transaction-local nordklart.allow_supersede GUC. Unlike
-- nordklart.allow_delete, this is NOT a blanket bypass — the trigger continues
...
BEGIN
  ...
  v_allow_supersede := current_setting('nordklart.allow_supersede', true) = 'true';
...
BEGIN
  ...
  PERFORM set_config('nordklart.allow_supersede', 'true', true);
