...
--
-- The MCP server can already stage customers via nordklart_create_customer, but
-- supplier creation (nordklart_create_supplier) requires its own staged op type
