...
-- Vercel, Docker, and hosted with no file-tracing config or .dockerignore surgery.
--
...
-- (nordklart_list_skills / nordklart_load_skill). Defaults true — an explicit, queryable
