...
-- in-app agent read skill content from the DB (works on Vercel, Docker, hosted).
...
- `references/bas-kontoplan.md` → `nordklart_load_skill("horizontal/swedish-accounting-compliance/bas-kontoplan")` — BAS Kontoplan Reference
- `references/bfl-bfnar.md` → `nordklart_load_skill("horizontal/swedish-accounting-compliance/bfl-bfnar")` — BFL, BFNAR, and ÅRL Reference
- `references/changes-2025-2026.md` → `nordklart_load_skill("horizontal/swedish-accounting-compliance/changes-2025-2026")` — Regulatory Changes 2024-2026
- `references/sie4.md` → `nordklart_load_skill("horizontal/swedish-accounting-compliance/sie4")` — SIE4 File Format Reference
- `references/skatteverket.md` → `nordklart_load_skill("horizontal/swedish-accounting-compliance/skatteverket")` — Skatteverket Reference
$gb$,
    NULL,
    3,
    1
...
- `references/accounts-and-registry.md` → `nordklart_load_skill("horizontal/swedish-asset-accounting/accounts-and-registry")` — BAS Account Mapping & Anläggningsregister
- `references/depreciaton.md` → `nordklart_load_skill("horizontal/swedish-asset-accounting/depreciaton")` — Depreciation Methods & Tax Rules
- `references/leasing-and-disposal.md` → `nordklart_load_skill("horizontal/swedish-asset-accounting/leasing-and-disposal")` — Leasing Treatment & Asset Disposal
$gb$,
    NULL,
    3,
    1
...
- `references/consumer-and-b2c.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/consumer-and-b2c")` — Consumer E-Faktura Ecosystem (B2C)
- `references/european-mandates.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/european-mandates")` — European E-Invoicing Mandates, Comparison and ViDA Timeline
- `references/implementation-guide.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/implementation-guide")` — Implementation Guide, Building Peppol into a Swedish Accounting Product
- `references/legal-and-regulatory.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/legal-and-regulatory")` — Legal and Regulatory Framework, Swedish E-Invoicing
- `references/market-provider-pricing.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/market-provider-pricing")` — Swedish E-Invoicing Market, Providers and Pricing
- `references/peppol-bis-billing.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/peppol-bis-billing")` — Peppol BIS Billing 3.0, Wire Format Reference
- `references/peppol-network.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/peppol-network")` — Peppol Network Architecture, AS4, SMP, SML, PKI
- `references/swedish-cius-and-specifics.md` → `nordklart_load_skill("horizontal/swedish-e-invoicing/swedish-cius-and-specifics")` — Sweden CIUS Rules and Accounting Integration
$gb$,
    NULL,
    5,
    1
...
- `references/arsredovisning-structure.md` → `nordklart_load_skill("horizontal/swedish-financial-reporting/arsredovisning-structure")` — Årsredovisning Document Structure (K2/K3)
- `references/bolagsverket-filing.md` → `nordklart_load_skill("horizontal/swedish-financial-reporting/bolagsverket-filing")` — Bolagsverket Filing Requirements
- `references/ink2-form-logic.md` → `nordklart_load_skill("horizontal/swedish-financial-reporting/ink2-form-logic")` — INK2 Form Logic
$gb$,
    NULL,
    3,
    1
...
- `references/invoice-rules.md` → `nordklart_load_skill("horizontal/swedish-invoice-compliance/invoice-rules")` — Swedish Invoice Compliance — Full Reference
$gb$,
    NULL,
    5,
    1
...
- `references/agi-filing.md` → `nordklart_load_skill("horizontal/swedish-payroll/agi-filing")` — Arbetsgivardeklaration (AGI) Filing
- `references/bas-7xxx.md` → `nordklart_load_skill("horizontal/swedish-payroll/bas-7xxx")` — BAS Kontoplan 7xxx: Salary Account Mapping
- `references/benefits.md` → `nordklart_load_skill("horizontal/swedish-payroll/benefits")` — Förmånsbeskattning (Benefit Taxation)
- `references/deductions-lonevaxling.md` → `nordklart_load_skill("horizontal/swedish-payroll/deductions-lonevaxling")` — Nettolöneavdrag vs Bruttolöneavdrag and Löneväxling
- `references/f-skatt.md` → `nordklart_load_skill("horizontal/swedish-payroll/f-skatt")` — F-skatt vs A-skatt
- `references/ob-overtime.md` → `nordklart_load_skill("horizontal/swedish-payroll/ob-overtime")` — Sjuklön (Sick Pay)
- `references/sick-pay.md` → `nordklart_load_skill("horizontal/swedish-payroll/sick-pay")` — Sjuklön (Sick Pay)
- `references/social-charges.md` → `nordklart_load_skill("horizontal/swedish-payroll/social-charges")` — Sociala avgifter (Arbetsgivaravgifter)
- `references/tax-tables.md` → `nordklart_load_skill("horizontal/swedish-payroll/tax-tables")` — Skatteavdrag (Tax Tables)
- `references/travel-expenses.md` → `nordklart_load_skill("horizontal/swedish-payroll/travel-expenses")` — Traktamente and Utlägg
- `references/vacation-pay.md` → `nordklart_load_skill("horizontal/swedish-payroll/vacation-pay")` — Semesterlöneskuld (Vacation Pay)
$gb$,
    NULL,
    3,
    1
...
- `references/accounts-and-entries.md` → `nordklart_load_skill("horizontal/swedish-project-accounting/accounts-and-entries")` — BAS Accounts and Journal Entries for Project Accounting
- `references/implementation-patterns.md` → `nordklart_load_skill("horizontal/swedish-project-accounting/implementation-patterns")` — Implementation Patterns for Project Accounting
- `references/k2-k3-revenue-recognition.md` → `nordklart_load_skill("horizontal/swedish-project-accounting/k2-k3-revenue-recognition")` — K2/K3 Revenue Recognition for Project Accounting
- `references/sie4-project-dimensions.md` → `nordklart_load_skill("horizontal/swedish-project-accounting/sie4-project-dimensions")` — SIE4 Project Dimensions
- `references/tax-and-grants.md` → `nordklart_load_skill("horizontal/swedish-project-accounting/tax-and-grants")` — Tax Implications and Grant Accounting for Projects
$gb$,
    NULL,
    3,
    1
...
- `references/bas-sru.md` → `nordklart_load_skill("horizontal/swedish-sie-import-export/bas-sru")` — BAS Kontoplan and SRU Code Reference for SIE4
- `references/encoding.md` → `nordklart_load_skill("horizontal/swedish-sie-import-export/encoding")` — SIE4 Character Encoding Reference
- `references/record-types.md` → `nordklart_load_skill("horizontal/swedish-sie-import-export/record-types")` — SIE4 Record Type Reference
- `references/validation-rules.md` → `nordklart_load_skill("horizontal/swedish-sie-import-export/validation-rules")` — SIE4 Validation Rules and Error Patterns
$gb$,
    NULL,
    3,
    1
...
- `references/sru-codes.md` → `nordklart_load_skill("horizontal/swedish-sru-filing/sru-codes")` — SRU Code Tables and BAS-to-SRU Mapping
$gb$,
    NULL,
    5,
    1
...
- `references/312-regler.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/312-regler")` — 3:12-reglerna (Fåmansbolag Dividend Taxation)
- `references/kapitalforsakring.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/kapitalforsakring")` — Kapitalförsäkring i bolagskontext
- `references/koncernbidrag.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/koncernbidrag")` — Koncernbidrag (Group Contributions)
- `references/overavskrivningar.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/overavskrivningar")` — Överavskrivningar (Accelerated Depreciation)
- `references/periodiseringsfond.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/periodiseringsfond")` — Periodiseringsfond (Tax Allocation Reserve)
- `references/ranteavdragsbegransningar.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/ranteavdragsbegransningar")` — Ränteavdragsbegränsningar (Interest Deduction Limitations)
- `references/strategy-and-interactions.md` → `nordklart_load_skill("horizontal/swedish-tax-planning/strategy-and-interactions")` — Strategy, Interactions, and Optimization
$gb$,
    NULL,
    3,
    1
...
- `references/vat-compliance-reference.md` → `nordklart_load_skill("horizontal/swedish-vat/vat-compliance-reference")` — Swedish VAT (Moms) Complete Compliance Reference
$gb$,
    NULL,
    3,
    1
...
- `references/closing-process.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/closing-process")` — Step-by-Step Closing Process with BAS Account Numbers
- `references/journal-entries.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/journal-entries")` — Specific Closing Journal Entries (Bokslutstransaktioner)
- `references/k2-vs-k3.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/k2-vs-k3")` — K2 vs K3: Implementation Differences for Year-End Closing
- `references/legal-framework.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/legal-framework")` — Legal Framework for Swedish Year-End Closing
- `references/pitfalls-and-rates.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/pitfalls-and-rates")` — Common Mistakes, Compliance Pitfalls, and Reference Rates
- `references/reporting-and-filing.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/reporting-and-filing")` — Reporting Obligations, Filing, and SIE4
- `references/tax-calculations.md` → `nordklart_load_skill("horizontal/swedish-year-end-closing/tax-calculations")` — Tax Calculations: AB vs Enskild Firma
$gb$,
    NULL,
    3,
    1
...
- `references/312-holding.md` → `nordklart_load_skill("modifier/holding-ab/312-holding")` — 3:12-reglerna i holdingstruktur — utvidgad referens
- `references/aktieagartillskott.md` → `nordklart_load_skill("modifier/holding-ab/aktieagartillskott")` — Aktieägartillskott — utvidgad referens
- `references/koncernbidrag.md` → `nordklart_load_skill("modifier/holding-ab/koncernbidrag")` — Koncernbidrag — utvidgad referens
- `references/kupongskatt-cfc.md` → `nordklart_load_skill("modifier/holding-ab/kupongskatt-cfc")` — Kupongskatt och CFC — utvidgad referens
- `references/moms-holdingbolag.md` → `nordklart_load_skill("modifier/holding-ab/moms-holdingbolag")` — Moms för holdingbolag — utvidgad referens
- `references/naringsbetingade-andelar.md` → `nordklart_load_skill("modifier/holding-ab/naringsbetingade-andelar")` — Näringsbetingade andelar och skalbolag — utvidgad referens
- `references/omstrukturering.md` → `nordklart_load_skill("modifier/holding-ab/omstrukturering")` — Omstruktureringar — utvidgad referens
- `references/ranteavdrag.md` → `nordklart_load_skill("modifier/holding-ab/ranteavdrag")` — Ränteavdragsbegränsning — utvidgad referens
$gb$,
    NULL,
    4,
    1
...
- `references/fordelningsnyckel-metoder.md` → `nordklart_load_skill("modifier/mixed-verksamhet/fordelningsnyckel-metoder")` — Fördelningsnyckel — metoder och val efter HFD 2023 ref. 45
- `references/frivillig-skattskyldighet-fastighet.md` → `nordklart_load_skill("modifier/mixed-verksamhet/frivillig-skattskyldighet-fastighet")` — Frivillig beskattning för fastighetsupplåtelser
- `references/holdingbolag-avdragsratt.md` → `nordklart_load_skill("modifier/mixed-verksamhet/holdingbolag-avdragsratt")` — Holdingbolag — avdragsrätt för ingående moms
- `references/jamkning-mechanics.md` → `nordklart_load_skill("modifier/mixed-verksamhet/jamkning-mechanics")` — Jämkning (justering) av ingående moms på investeringsvaror
$gb$,
    NULL,
    3,
    1
...
- `references/kollektivavtal.md` → `nordklart_load_skill("vertical/bygg-hantverk/kollektivavtal")` — Kollektivavtal per sub-vertikal inom SNI 41–43
- `references/momsregler.md` → `nordklart_load_skill("vertical/bygg-hantverk/momsregler")` — Omvänd betalningsskyldighet inom byggsektorn – fördjupning
- `references/pagaende-arbeten.md` → `nordklart_load_skill("vertical/bygg-hantverk/pagaende-arbeten")` — Pågående arbeten – K3, K2, IL – flödesexempel
- `references/praxis.md` → `nordklart_load_skill("vertical/bygg-hantverk/praxis")` — HFD-domar och Skatteverkets ställningstaganden 2020–2026 – bygg-vertikalen
- `references/rot-faktura-exempel.md` → `nordklart_load_skill("vertical/bygg-hantverk/rot-faktura-exempel")` — ROT-fakturering enligt fakturamodellen – flöde och kontering
$gb$,
    NULL,
    3,
    1
...
- `references/dac7-rapportering.md` → `nordklart_load_skill("vertical/e-handel/dac7-rapportering")` — DAC7 — plattformsoperatörers rapporteringsskyldighet
- `references/dropshipping-kedjetransaktioner.md` → `nordklart_load_skill("vertical/e-handel/dropshipping-kedjetransaktioner")` — Dropshipping och kedjetransaktioner — beslutsschema
- `references/kollektivavtal-lager-e-handel.md` → `nordklart_load_skill("vertical/e-handel/kollektivavtal-lager-e-handel")` — Lager- och E-handelsavtalet 2025–2027
- `references/konsumentratt.md` → `nordklart_load_skill("vertical/e-handel/konsumentratt")` — Konsumenträtt — distansavtalslagen, KKL, MFL, prisinformation, GPSR
- `references/marketplace-deemed-supplier.md` → `nordklart_load_skill("vertical/e-handel/marketplace-deemed-supplier")` — Marketplace deemed supplier — 5 kap. 5–6 §§ ML 2023:200
- `references/oss-ioss-mekanik.md` → `nordklart_load_skill("vertical/e-handel/oss-ioss-mekanik")` — OSS- och IOSS-mekanik
- `references/payment-providers.md` → `nordklart_load_skill("vertical/e-handel/payment-providers")` — Payment Provider — bokföringsmappning per aktör
- `references/skv-stallningstaganden-katalog.md` → `nordklart_load_skill("vertical/e-handel/skv-stallningstaganden-katalog")` — Skatteverkets ställningstaganden och HFD-domar — e-handelskatalog
- `references/vouchers-presentkort.md` → `nordklart_load_skill("vertical/e-handel/vouchers-presentkort")` — Vouchers och presentkort — SPV vs MPV
$gb$,
    NULL,
    3,
    1
...
- `references/3-12-rules.md` → `nordklart_load_skill("vertical/konsult-it/3-12-rules")` — 3:12-reglerna (IL 57 kap) — full reference
- `references/consultant-vs-employee.md` → `nordklart_load_skill("vertical/konsult-it/consultant-vs-employee")` — Consultant vs employee classification (uppdragstagare vs arbetstagare)
- `references/cross-border-payroll.md` → `nordklart_load_skill("vertical/konsult-it/cross-border-payroll")` — Cross-border payroll for IT consultants
- `references/electronic-services-classification.md` → `nordklart_load_skill("vertical/konsult-it/electronic-services-classification")` — Electronic services classification (moms)
- `references/invoice-templates.md` → `nordklart_load_skill("vertical/konsult-it/invoice-templates")` — Invoice text library — IT consulting (Sweden)
- `references/software-capitalization.md` → `nordklart_load_skill("vertical/konsult-it/software-capitalization")` — Software capitalization — K3, K2, IFRS
$gb$,
    NULL,
    4,
    1
