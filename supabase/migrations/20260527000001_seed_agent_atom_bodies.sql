...
**Software implication**: your system should support read-only access for Skatteverket during revision. Event-sourced architecture (like nordklart's CQRS/Emmett setup) naturally supports this through immutable event logs. Consider building a dedicated API endpoint or export mechanism.
...
### Implications for Luka/nordklart
