...
-- 4c. enforce_journal_entry_immutability — supports nordklart.allow_delete + cancelled
...
-- 4d. enforce_journal_entry_line_immutability — supports nordklart.allow_delete + cancelled
...
-- 4e. enforce_retention_journal_entries — supports nordklart.allow_delete
